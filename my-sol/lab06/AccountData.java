...
public class AccountData implements Keyable {
  ...
  /**
   *  isValid() returns whether the amount is a valid number.
   **/
  public boolean isValid(int amount) throws BadTransactionException {
    if (amount < 0) {
      throw new BadTransactionException("Invalid amount value: " + amount);
    } else {
      return true;
    }
  }
