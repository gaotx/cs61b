...
@primitive("randlist")
def scheme_randlist(lst):
	return random.choice(lst)

@primitive("converthex")
def scheme_converthex(hex):
	return int(hex, 16)

@primitive("convertdec")
def scheme_convertdec(dec):
	return hex(dec)
...
def tscheme_init():
	"""initialize turtle"""
	tscheme_background(0, 0, 0)
	turtle.hideturtle()
	tscheme_speed(0)
	tscheme_setheading(0)
	tscheme_setposition(0, 0)
	turtle.clear()
	screen = turtle.getscreen()
	screen.screensize(1440, 900)
